...
//			String[] arguments = { "CAR1", "Chevy", "Volt", "Red", "Nick" };
			...
			Collection<ProposalResponse>  responsesQuery = channelClient.queryByChainCode("bitcoupon", "queryAllCars", null);
			...
			Thread.sleep(10000);
			String[] args1 = {"CAR1"};
			Collection<ProposalResponse>  responses1Query = channelClient.queryByChainCode("bitcoupon", "queryCar", args1);
